...
и приложите скриншот развертывания helm и вывода https://cinemaabyss.example.com/api/movies<br>
<br>
Результат:
- [Helm](screenshots/helm%20release.png)
- [/api/movies](screenshots/Helm%20GET%20cinemaabyss.example.com_api_movies.png)
